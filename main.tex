...
\usepackage{fancyhdr}
\usepackage[margin=3cm,top=3cm,bottom=2cm,left=3cm,right=2cm,includehead]{geometry}
...
\makeatletter
\fancypagestyle{plain}{% normal pages
    \fancyhf{}
    \renewcommand{\headrulewidth}{0pt}
    \fancyhead[R]{\vspace*{1.5\baselineskip}\thepage}
    \renewcommand{\headrulewidth}{0pt}
}
...
em Bioinformática}}
    ...
    \end{titlepage}
    % Ficha biblioteca
    \includepdf[pages=-,scale=.9]{declaracoes/Bioinformática. Gabriel Marinello Moura Leite. Mestrado. Ficha catalográfica.pdf}
    % Ata de defesa
    ...
    \setcounter{page}{10} % Start counting from page 10
