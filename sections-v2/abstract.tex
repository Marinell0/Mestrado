...
\begin{abstract}
    ...
    These implementations are in being used in several systems with benefits for users. In particular, we mention the workflow CTTX, which was unified with the Good Laboratory Practices (GLP) workflow for sharing information on the equipment used. We also mention the dynamic visualization of the CENTRARE workflow, used in the whale hospital, to facilitate the search for information within the workflow.
\end{abstract}
