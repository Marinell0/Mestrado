...
\begin{abstract}
    ...
    LIMS baseados em workflows são sistemas utilizam do modelo de processo de negócios (BPM) de uma organização, que são representações visuais de como as atividades de negócio são realizadas para melhorar a eficiência e otimizar os processos organizacionais. Estes sistemas tem como vantagem a disponibilização deste processo para que usuários possam executar seus trabalhos de forma eficiente, ordenada e com agilidade, mantendo as informações no sistema para que outros usuários possam acessar.
